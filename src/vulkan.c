...
void gladLoaderResetVulkan(void) {
    GLAD_VK_VERSION_1_0 = 0;
    GLAD_VK_VERSION_1_1 = 0;
    GLAD_VK_VERSION_1_2 = 0;
    GLAD_VK_VERSION_1_3 = 0;

    GLAD_VK_AMD_buffer_marker = 0;
    GLAD_VK_AMD_device_coherent_memory = 0;
    GLAD_VK_AMD_display_native_hdr = 0;
    GLAD_VK_AMD_draw_indirect_count = 0;
    GLAD_VK_AMD_gcn_shader = 0;
    GLAD_VK_AMD_gpu_shader_half_float = 0;
    GLAD_VK_AMD_gpu_shader_int16 = 0;
    GLAD_VK_AMD_memory_overallocation_behavior = 0;
    GLAD_VK_AMD_mixed_attachment_samples = 0;
    GLAD_VK_AMD_negative_viewport_height = 0;
    GLAD_VK_AMD_pipeline_compiler_control = 0;
    GLAD_VK_AMD_rasterization_order = 0;
    GLAD_VK_AMD_shader_ballot = 0;
    GLAD_VK_AMD_shader_core_properties = 0;
    GLAD_VK_AMD_shader_core_properties2 = 0;
    GLAD_VK_AMD_shader_early_and_late_fragment_tests = 0;
    GLAD_VK_AMD_shader_explicit_vertex_parameter = 0;
    GLAD_VK_AMD_shader_fragment_mask = 0;
    GLAD_VK_AMD_shader_image_load_store_lod = 0;
    GLAD_VK_AMD_shader_info = 0;
    GLAD_VK_AMD_shader_trinary_minmax = 0;
    GLAD_VK_AMD_texture_gather_bias_lod = 0;
#if defined(VK_USE_PLATFORM_ANDROID_KHR)
    GLAD_VK_ANDROID_external_memory_android_hardware_buffer = 0;

#endif
    GLAD_VK_ARM_rasterization_order_attachment_access = 0;
    GLAD_VK_ARM_shader_core_builtins = 0;
    GLAD_VK_EXT_4444_formats = 0;
    GLAD_VK_EXT_acquire_drm_display = 0;
#if defined(VK_USE_PLATFORM_XLIB_XRANDR_EXT)
    GLAD_VK_EXT_acquire_xlib_display = 0;

#endif
    GLAD_VK_EXT_astc_decode_mode = 0;
    GLAD_VK_EXT_attachment_feedback_loop_layout = 0;
    GLAD_VK_EXT_blend_operation_advanced = 0;
    GLAD_VK_EXT_border_color_swizzle = 0;
    GLAD_VK_EXT_buffer_device_address = 0;
    GLAD_VK_EXT_calibrated_timestamps = 0;
    GLAD_VK_EXT_color_write_enable = 0;
    GLAD_VK_EXT_conditional_rendering = 0;
    GLAD_VK_EXT_conservative_rasterization = 0;
    GLAD_VK_EXT_custom_border_color = 0;
    GLAD_VK_EXT_debug_marker = 0;
    GLAD_VK_EXT_debug_report = 0;
    GLAD_VK_EXT_debug_utils = 0;
    GLAD_VK_EXT_depth_clamp_zero_one = 0;
    ...
    GLAD_VK_EXT_device_memory_report = 0;
    GLAD_VK_EXT_direct_mode_display = 0;
#if defined(VK_USE_PLATFORM_DIRECTFB_EXT)
    GLAD_VK_EXT_directfb_surface = 0;

#endif
    GLAD_VK_EXT_discard_rectangles = 0;
    GLAD_VK_EXT_display_control = 0;
    GLAD_VK_EXT_display_surface_counter = 0;
    GLAD_VK_EXT_extended_dynamic_state = 0;
    GLAD_VK_EXT_extended_dynamic_state2 = 0;
    GLAD_VK_EXT_extended_dynamic_state3 = 0;
    GLAD_VK_EXT_external_memory_dma_buf = 0;
    GLAD_VK_EXT_external_memory_host = 0;
    GLAD_VK_EXT_filter_cubic = 0;
    GLAD_VK_EXT_fragment_density_map = 0;
    GLAD_VK_EXT_fragment_density_map2 = 0;
    GLAD_VK_EXT_fragment_shader_interlock = 0;
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    GLAD_VK_EXT_full_screen_exclusive = 0;

#endif
    GLAD_VK_EXT_global_priority = 0;
    GLAD_VK_EXT_global_priority_query = 0;
    GLAD_VK_EXT_graphics_pipeline_library = 0;
    GLAD_VK_EXT_hdr_metadata = 0;
    GLAD_VK_EXT_headless_surface = 0;
    GLAD_VK_EXT_host_query_reset = 0;
    GLAD_VK_EXT_image_2d_view_of_3d = 0;
    GLAD_VK_EXT_image_compression_control = 0;
    GLAD_VK_EXT_image_compression_control_swapchain = 0;
    GLAD_VK_EXT_image_drm_format_modifier = 0;
    GLAD_VK_EXT_image_robustness = 0;
    GLAD_VK_EXT_image_view_min_lod = 0;
    GLAD_VK_EXT_index_type_uint8 = 0;
    GLAD_VK_EXT_inline_uniform_block = 0;
    GLAD_VK_EXT_legacy_dithering = 0;
    GLAD_VK_EXT_line_rasterization = 0;
    GLAD_VK_EXT_load_store_op_none = 0;
    GLAD_VK_EXT_memory_budget = 0;
    GLAD_VK_EXT_memory_priority = 0;
    GLAD_VK_EXT_mesh_shader = 0;
#if defined(VK_USE_PLATFORM_METAL_EXT)
    GLAD_VK_EXT_metal_objects = 0;

#endif
#if defined(VK_USE_PLATFORM_METAL_EXT)
    GLAD_VK_EXT_metal_surface = 0;

#endif
    GLAD_VK_EXT_multi_draw = 0;
    GLAD_VK_EXT_multisampled_render_to_single_sampled = 0;
    GLAD_VK_EXT_mutable_descriptor_type = 0;
    GLAD_VK_EXT_non_seamless_cube_map = 0;
    GLAD_VK_EXT_opacity_micromap = 0;
    GLAD_VK_EXT_pageable_device_local_memory = 0;
    GLAD_VK_EXT_pci_bus_info = 0;
    GLAD_VK_EXT_physical_device_drm = 0;
    GLAD_VK_EXT_pipeline_creation_cache_control = 0;
    GLAD_VK_EXT_pipeline_creation_feedback = 0;
    GLAD_VK_EXT_pipeline_properties = 0;
    GLAD_VK_EXT_pipeline_protected_access = 0;
    GLAD_VK_EXT_pipeline_robustness = 0;
    GLAD_VK_EXT_post_depth_coverage = 0;
    GLAD_VK_EXT_primitive_topology_list_restart = 0;
    GLAD_VK_EXT_primitives_generated_query = 0;
    GLAD_VK_EXT_private_data = 0;
    GLAD_VK_EXT_provoking_vertex = 0;
    GLAD_VK_EXT_queue_family_foreign = 0;
    GLAD_VK_EXT_rasterization_order_attachment_access = 0;
    GLAD_VK_EXT_rgba10x6_formats = 0;
    GLAD_VK_EXT_robustness2 = 0;
    GLAD_VK_EXT_sample_locations = 0;
    GLAD_VK_EXT_sampler_filter_minmax = 0;
    GLAD_VK_EXT_scalar_block_layout = 0;
    GLAD_VK_EXT_separate_stencil_usage = 0;
    GLAD_VK_EXT_shader_atomic_float = 0;
    GLAD_VK_EXT_shader_atomic_float2 = 0;
    GLAD_VK_EXT_shader_demote_to_helper_invocation = 0;
    GLAD_VK_EXT_shader_image_atomic_int64 = 0;
    GLAD_VK_EXT_shader_module_identifier = 0;
    GLAD_VK_EXT_shader_stencil_export = 0;
    GLAD_VK_EXT_shader_subgroup_ballot = 0;
    GLAD_VK_EXT_shader_subgroup_vote = 0;
    GLAD_VK_EXT_shader_viewport_index_layer = 0;
    GLAD_VK_EXT_subgroup_size_control = 0;
    GLAD_VK_EXT_subpass_merge_feedback = 0;
    GLAD_VK_EXT_swapchain_colorspace = 0;
    GLAD_VK_EXT_texel_buffer_alignment = 0;
    GLAD_VK_EXT_texture_compression_astc_hdr = 0;
    GLAD_VK_EXT_tooling_info = 0;
    GLAD_VK_EXT_transform_feedback = 0;
    GLAD_VK_EXT_validation_cache = 0;
    GLAD_VK_EXT_validation_features = 0;
    GLAD_VK_EXT_validation_flags = 0;
    GLAD_VK_EXT_vertex_attribute_divisor = 0;
    GLAD_VK_EXT_vertex_input_dynamic_state = 0;
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    GLAD_VK_EXT_video_decode_h264 = 0;

#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    GLAD_VK_EXT_video_decode_h265 = 0;

#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    GLAD_VK_EXT_video_encode_h264 = 0;

#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    GLAD_VK_EXT_video_encode_h265 = 0;

#endif
    GLAD_VK_EXT_ycbcr_2plane_444_formats = 0;
    GLAD_VK_EXT_ycbcr_image_arrays = 0;
#if defined(VK_USE_PLATFORM_FUCHSIA)
    GLAD_VK_FUCHSIA_buffer_collection = 0;

#endif
#if defined(VK_USE_PLATFORM_FUCHSIA)
    GLAD_VK_FUCHSIA_external_memory = 0;

#endif
#if defined(VK_USE_PLATFORM_FUCHSIA)
    GLAD_VK_FUCHSIA_external_semaphore = 0;

#endif
#if defined(VK_USE_PLATFORM_FUCHSIA)
    GLAD_VK_FUCHSIA_imagepipe_surface = 0;

#endif
#if defined(VK_USE_PLATFORM_GGP)
    GLAD_VK_GGP_frame_token = 0;

#endif
#if defined(VK_USE_PLATFORM_GGP)
    GLAD_VK_GGP_stream_descriptor_surface = 0;

#endif
    GLAD_VK_GOOGLE_decorate_string = 0;
    GLAD_VK_GOOGLE_display_timing = 0;
    GLAD_VK_GOOGLE_hlsl_functionality1 = 0;
    GLAD_VK_GOOGLE_surfaceless_query = 0;
    GLAD_VK_GOOGLE_user_type = 0;
    GLAD_VK_HUAWEI_invocation_mask = 0;
    GLAD_VK_HUAWEI_subpass_shading = 0;
    GLAD_VK_IMG_filter_cubic = 0;
    GLAD_VK_IMG_format_pvrtc = 0;
    GLAD_VK_INTEL_performance_query = 0;
    GLAD_VK_INTEL_shader_integer_functions2 = 0;
    GLAD_VK_KHR_16bit_storage = 0;
    GLAD_VK_KHR_8bit_storage = 0;
    GLAD_VK_KHR_acceleration_structure = 0;
#if defined(VK_USE_PLATFORM_ANDROID_KHR)
    GLAD_VK_KHR_android_surface = 0;

#endif
    GLAD_VK_KHR_bind_memory2 = 0;
    GLAD_VK_KHR_buffer_device_address = 0;
    GLAD_VK_KHR_copy_commands2 = 0;
    GLAD_VK_KHR_create_renderpass2 = 0;
    GLAD_VK_KHR_dedicated_allocation = 0;
    GLAD_VK_KHR_deferred_host_operations = 0;
    GLAD_VK_KHR_depth_stencil_resolve = 0;
    GLAD_VK_KHR_descriptor_update_template = 0;
    GLAD_VK_KHR_device_group = 0;
    GLAD_VK_KHR_device_group_creation = 0;
    GLAD_VK_KHR_display = 0;
    GLAD_VK_KHR_display_swapchain = 0;
    GLAD_VK_KHR_draw_indirect_count = 0;
    GLAD_VK_KHR_driver_properties = 0;
    GLAD_VK_KHR_dynamic_rendering = 0;
    GLAD_VK_KHR_external_fence = 0;
    GLAD_VK_KHR_external_fence_capabilities = 0;
    GLAD_VK_KHR_external_fence_fd = 0;
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    GLAD_VK_KHR_external_fence_win32 = 0;

#endif
    GLAD_VK_KHR_external_memory = 0;
    GLAD_VK_KHR_external_memory_capabilities = 0;
    GLAD_VK_KHR_external_memory_fd = 0;
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    GLAD_VK_KHR_external_memory_win32 = 0;

#endif
    GLAD_VK_KHR_external_semaphore = 0;
    GLAD_VK_KHR_external_semaphore_capabilities = 0;
    GLAD_VK_KHR_external_semaphore_fd = 0;
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    GLAD_VK_KHR_external_semaphore_win32 = 0;

#endif
    GLAD_VK_KHR_format_feature_flags2 = 0;
    GLAD_VK_KHR_fragment_shader_barycentric = 0;
    GLAD_VK_KHR_fragment_shading_rate = 0;
    GLAD_VK_KHR_get_display_properties2 = 0;
    GLAD_VK_KHR_get_memory_requirements2 = 0;
    GLAD_VK_KHR_get_physical_device_properties2 = 0;
    GLAD_VK_KHR_get_surface_capabilities2 = 0;
    GLAD_VK_KHR_global_priority = 0;
    GLAD_VK_KHR_image_format_list = 0;
    GLAD_VK_KHR_imageless_framebuffer = 0;
    GLAD_VK_KHR_incremental_present = 0;
    GLAD_VK_KHR_maintenance1 = 0;
    GLAD_VK_KHR_maintenance2 = 0;
    GLAD_VK_KHR_maintenance3 = 0;
    GLAD_VK_KHR_maintenance4 = 0;
    GLAD_VK_KHR_multiview = 0;
    GLAD_VK_KHR_performance_query = 0;
    GLAD_VK_KHR_pipeline_executable_properties = 0;
    GLAD_VK_KHR_pipeline_library = 0;
    GLAD_VK_KHR_portability_enumeration = 0;
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    GLAD_VK_KHR_portability_subset = 0;

#endif
    GLAD_VK_KHR_present_id = 0;
    GLAD_VK_KHR_present_wait = 0;
    GLAD_VK_KHR_push_descriptor = 0;
    GLAD_VK_KHR_ray_query = 0;
    GLAD_VK_KHR_ray_tracing_maintenance1 = 0;
    GLAD_VK_KHR_ray_tracing_pipeline = 0;
    GLAD_VK_KHR_relaxed_block_layout = 0;
    GLAD_VK_KHR_sampler_mirror_clamp_to_edge = 0;
    GLAD_VK_KHR_sampler_ycbcr_conversion = 0;
    GLAD_VK_KHR_separate_depth_stencil_layouts = 0;
    GLAD_VK_KHR_shader_atomic_int64 = 0;
    GLAD_VK_KHR_shader_clock = 0;
    GLAD_VK_KHR_shader_draw_parameters = 0;
    GLAD_VK_KHR_shader_float16_int8 = 0;
    GLAD_VK_KHR_shader_float_controls = 0;
    GLAD_VK_KHR_shader_integer_dot_product = 0;
    GLAD_VK_KHR_shader_non_semantic_info = 0;
    GLAD_VK_KHR_shader_subgroup_extended_types = 0;
    GLAD_VK_KHR_shader_subgroup_uniform_control_flow = 0;
    GLAD_VK_KHR_shader_terminate_invocation = 0;
    GLAD_VK_KHR_shared_presentable_image = 0;
    GLAD_VK_KHR_spirv_1_4 = 0;
    GLAD_VK_KHR_storage_buffer_storage_class = 0;
    GLAD_VK_KHR_surface = 0;
    GLAD_VK_KHR_surface_protected_capabilities = 0;
    GLAD_VK_KHR_swapchain = 0;
    GLAD_VK_KHR_swapchain_mutable_format = 0;
    GLAD_VK_KHR_synchronization2 = 0;
    GLAD_VK_KHR_timeline_semaphore = 0;
    GLAD_VK_KHR_uniform_buffer_standard_layout = 0;
    GLAD_VK_KHR_variable_pointers = 0;
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    GLAD_VK_KHR_video_decode_queue = 0;

#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    GLAD_VK_KHR_video_encode_queue = 0;

#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    GLAD_VK_KHR_video_queue = 0;

#endif
    GLAD_VK_KHR_vulkan_memory_model = 0;
#if defined(VK_USE_PLATFORM_WAYLAND_KHR)
    GLAD_VK_KHR_wayland_surface = 0;

#endif
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    GLAD_VK_KHR_win32_keyed_mutex = 0;

#endif
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    GLAD_VK_KHR_win32_surface = 0;

#endif
    GLAD_VK_KHR_workgroup_memory_explicit_layout = 0;
#if defined(VK_USE_PLATFORM_XCB_KHR)
    GLAD_VK_KHR_xcb_surface = 0;

#endif
#if defined(VK_USE_PLATFORM_XLIB_KHR)
    GLAD_VK_KHR_xlib_surface = 0;

#endif
    GLAD_VK_KHR_zero_initialize_workgroup_memory = 0;
#if defined(VK_USE_PLATFORM_IOS_MVK)
    GLAD_VK_MVK_ios_surface = 0;

#endif
#if defined(VK_USE_PLATFORM_MACOS_MVK)
    GLAD_VK_MVK_macos_surface = 0;

#endif
#if defined(VK_USE_PLATFORM_VI_NN)
    GLAD_VK_NN_vi_surface = 0;

#endif
    GLAD_VK_NVX_binary_import = 0;
    GLAD_VK_NVX_image_view_handle = 0;
    GLAD_VK_NVX_multiview_per_view_attributes = 0;
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    GLAD_VK_NV_acquire_winrt_display = 0;
    ...
    GLAD_VK_NV_dedicated_allocation_image_aliasing = 0;
    GLAD_VK_NV_device_diagnostic_checkpoints = 0;
    GLAD_VK_NV_device_diagnostics_config = 0;
    GLAD_VK_NV_device_generated_commands = 0;
    GLAD_VK_NV_external_memory = 0;
    GLAD_VK_NV_external_memory_capabilities = 0;
    GLAD_VK_NV_external_memory_rdma = 0;
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    GLAD_VK_NV_external_memory_win32 = 0;

#endif
    GLAD_VK_NV_fill_rectangle = 0;
    GLAD_VK_NV_fragment_coverage_to_color = 0;
    GLAD_VK_NV_fragment_shader_barycentric = 0;
    GLAD_VK_NV_fragment_shading_rate_enums = 0;
    GLAD_VK_NV_framebuffer_mixed_samples = 0;
    GLAD_VK_NV_geometry_shader_passthrough = 0;
    ...
    GLAD_VK_NV_scissor_exclusive = 0;
    GLAD_VK_NV_shader_image_footprint = 0;
    GLAD_VK_NV_shader_sm_builtins = 0;
    GLAD_VK_NV_shader_subgroup_partitioned = 0;
    GLAD_VK_NV_shading_rate_image = 0;
    GLAD_VK_NV_viewport_array2 = 0;
    GLAD_VK_NV_viewport_swizzle = 0;
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    GLAD_VK_NV_win32_keyed_mutex = 0;

#endif
    GLAD_VK_QCOM_fragment_density_map_offset = 0;
    GLAD_VK_QCOM_image_processing = 0;
    GLAD_VK_QCOM_render_pass_shader_resolve = 0;
    GLAD_VK_QCOM_render_pass_store_ops = 0;
    GLAD_VK_QCOM_render_pass_transform = 0;
    GLAD_VK_QCOM_rotated_copy_commands = 0;
    GLAD_VK_QCOM_tile_properties = 0;
#if defined(VK_USE_PLATFORM_SCREEN_QNX)
    GLAD_VK_QNX_screen_surface = 0;

#endif
    GLAD_VK_SEC_amigo_profiling = 0;
    GLAD_VK_VALVE_descriptor_set_host_mapping = 0;
    GLAD_VK_VALVE_mutable_descriptor_type = 0;

    glad_vkAllocateCommandBuffers = NULL;
    glad_vkAllocateDescriptorSets = NULL;
    glad_vkAllocateMemory = NULL;
    glad_vkBeginCommandBuffer = NULL;
    glad_vkBindBufferMemory = NULL;
    glad_vkBindImageMemory = NULL;
    glad_vkCmdBeginQuery = NULL;
    glad_vkCmdBeginRenderPass = NULL;
    glad_vkCmdBindDescriptorSets = NULL;
    glad_vkCmdBindIndexBuffer = NULL;
    glad_vkCmdBindPipeline = NULL;
    glad_vkCmdBindVertexBuffers = NULL;
    glad_vkCmdBlitImage = NULL;
    glad_vkCmdClearAttachments = NULL;
    glad_vkCmdClearColorImage = NULL;
    glad_vkCmdClearDepthStencilImage = NULL;
    glad_vkCmdCopyBuffer = NULL;
    glad_vkCmdCopyBufferToImage = NULL;
    glad_vkCmdCopyImage = NULL;
    glad_vkCmdCopyImageToBuffer = NULL;
    glad_vkCmdCopyQueryPoolResults = NULL;
    glad_vkCmdDispatch = NULL;
    glad_vkCmdDispatchIndirect = NULL;
    glad_vkCmdDraw = NULL;
    glad_vkCmdDrawIndexed = NULL;
    glad_vkCmdDrawIndexedIndirect = NULL;
    glad_vkCmdDrawIndirect = NULL;
    glad_vkCmdEndQuery = NULL;
    glad_vkCmdEndRenderPass = NULL;
    glad_vkCmdExecuteCommands = NULL;
    glad_vkCmdFillBuffer = NULL;
    glad_vkCmdNextSubpass = NULL;
    glad_vkCmdPipelineBarrier = NULL;
    glad_vkCmdPushConstants = NULL;
    glad_vkCmdResetEvent = NULL;
    glad_vkCmdResetQueryPool = NULL;
    glad_vkCmdResolveImage = NULL;
    glad_vkCmdSetBlendConstants = NULL;
    glad_vkCmdSetDepthBias = NULL;
    glad_vkCmdSetDepthBounds = NULL;
    glad_vkCmdSetEvent = NULL;
    glad_vkCmdSetLineWidth = NULL;
    glad_vkCmdSetScissor = NULL;
    glad_vkCmdSetStencilCompareMask = NULL;
    glad_vkCmdSetStencilReference = NULL;
    glad_vkCmdSetStencilWriteMask = NULL;
    glad_vkCmdSetViewport = NULL;
    glad_vkCmdUpdateBuffer = NULL;
    glad_vkCmdWaitEvents = NULL;
    glad_vkCmdWriteTimestamp = NULL;
    glad_vkCreateBuffer = NULL;
    glad_vkCreateBufferView = NULL;
    glad_vkCreateCommandPool = NULL;
    glad_vkCreateComputePipelines = NULL;
    glad_vkCreateDescriptorPool = NULL;
    glad_vkCreateDescriptorSetLayout = NULL;
    glad_vkCreateDevice = NULL;
    glad_vkCreateEvent = NULL;
    glad_vkCreateFence = NULL;
    glad_vkCreateFramebuffer = NULL;
    glad_vkCreateGraphicsPipelines = NULL;
    glad_vkCreateImage = NULL;
    glad_vkCreateImageView = NULL;
    glad_vkCreateInstance = NULL;
    glad_vkCreatePipelineCache = NULL;
    glad_vkCreatePipelineLayout = NULL;
    glad_vkCreateQueryPool = NULL;
    glad_vkCreateRenderPass = NULL;
    glad_vkCreateSampler = NULL;
    glad_vkCreateSemaphore = NULL;
    glad_vkCreateShaderModule = NULL;
    glad_vkDestroyBuffer = NULL;
    glad_vkDestroyBufferView = NULL;
    glad_vkDestroyCommandPool = NULL;
    glad_vkDestroyDescriptorPool = NULL;
    glad_vkDestroyDescriptorSetLayout = NULL;
    glad_vkDestroyDevice = NULL;
    glad_vkDestroyEvent = NULL;
    glad_vkDestroyFence = NULL;
    glad_vkDestroyFramebuffer = NULL;
    glad_vkDestroyImage = NULL;
    glad_vkDestroyImageView = NULL;
    glad_vkDestroyInstance = NULL;
    glad_vkDestroyPipeline = NULL;
    glad_vkDestroyPipelineCache = NULL;
    glad_vkDestroyPipelineLayout = NULL;
    glad_vkDestroyQueryPool = NULL;
    glad_vkDestroyRenderPass = NULL;
    glad_vkDestroySampler = NULL;
    glad_vkDestroySemaphore = NULL;
    glad_vkDestroyShaderModule = NULL;
    glad_vkDeviceWaitIdle = NULL;
    glad_vkEndCommandBuffer = NULL;
    glad_vkEnumerateDeviceExtensionProperties = NULL;
    glad_vkEnumerateDeviceLayerProperties = NULL;
    glad_vkEnumerateInstanceExtensionProperties = NULL;
    glad_vkEnumerateInstanceLayerProperties = NULL;
    glad_vkEnumeratePhysicalDevices = NULL;
    glad_vkFlushMappedMemoryRanges = NULL;
    glad_vkFreeCommandBuffers = NULL;
    glad_vkFreeDescriptorSets = NULL;
    glad_vkFreeMemory = NULL;
    glad_vkGetBufferMemoryRequirements = NULL;
    glad_vkGetDeviceMemoryCommitment = NULL;
    glad_vkGetDeviceProcAddr = NULL;
    glad_vkGetDeviceQueue = NULL;
    glad_vkGetEventStatus = NULL;
    glad_vkGetFenceStatus = NULL;
    glad_vkGetImageMemoryRequirements = NULL;
    glad_vkGetImageSparseMemoryRequirements = NULL;
    glad_vkGetImageSubresourceLayout = NULL;
    glad_vkGetInstanceProcAddr = NULL;
    glad_vkGetPhysicalDeviceFeatures = NULL;
    ...
    glad_vkGetPhysicalDeviceProperties = NULL;
    glad_vkGetPhysicalDeviceQueueFamilyProperties = NULL;
    glad_vkGetPhysicalDeviceSparseImageFormatProperties = NULL;
    glad_vkGetPipelineCacheData = NULL;
    glad_vkGetQueryPoolResults = NULL;
    glad_vkGetRenderAreaGranularity = NULL;
    glad_vkInvalidateMappedMemoryRanges = NULL;
    glad_vkMapMemory = NULL;
    glad_vkMergePipelineCaches = NULL;
    glad_vkQueueBindSparse = NULL;
    glad_vkQueueSubmit = NULL;
    glad_vkQueueWaitIdle = NULL;
    glad_vkResetCommandBuffer = NULL;
    glad_vkResetCommandPool = NULL;
    glad_vkResetDescriptorPool = NULL;
    glad_vkResetEvent = NULL;
    glad_vkResetFences = NULL;
    glad_vkSetEvent = NULL;
    glad_vkUnmapMemory = NULL;
    glad_vkUpdateDescriptorSets = NULL;
    glad_vkWaitForFences = NULL;
    glad_vkBindBufferMemory2 = NULL;
    glad_vkBindImageMemory2 = NULL;
    glad_vkCmdDispatchBase = NULL;
    glad_vkCmdSetDeviceMask = NULL;
    glad_vkCreateDescriptorUpdateTemplate = NULL;
    glad_vkCreateSamplerYcbcrConversion = NULL;
    glad_vkDestroyDescriptorUpdateTemplate = NULL;
    glad_vkDestroySamplerYcbcrConversion = NULL;
    glad_vkEnumerateInstanceVersion = NULL;
    glad_vkEnumeratePhysicalDeviceGroups = NULL;
    glad_vkGetBufferMemoryRequirements2 = NULL;
    glad_vkGetDescriptorSetLayoutSupport = NULL;
    glad_vkGetDeviceGroupPeerMemoryFeatures = NULL;
    glad_vkGetDeviceQueue2 = NULL;
    glad_vkGetImageMemoryRequirements2 = NULL;
    ...
    glad_vkGetPhysicalDeviceFeatures2 = NULL;
    ...
    glad_vkGetPhysicalDeviceProperties2 = NULL;
    glad_vkGetPhysicalDeviceQueueFamilyProperties2 = NULL;
    glad_vkGetPhysicalDeviceSparseImageFormatProperties2 = NULL;
    glad_vkTrimCommandPool = NULL;
    glad_vkUpdateDescriptorSetWithTemplate = NULL;
    glad_vkCmdBeginRenderPass2 = NULL;
    glad_vkCmdDrawIndexedIndirectCount = NULL;
    glad_vkCmdDrawIndirectCount = NULL;
    glad_vkCmdEndRenderPass2 = NULL;
    glad_vkCmdNextSubpass2 = NULL;
    glad_vkCreateRenderPass2 = NULL;
    glad_vkGetBufferDeviceAddress = NULL;
    glad_vkGetBufferOpaqueCaptureAddress = NULL;
    glad_vkGetDeviceMemoryOpaqueCaptureAddress = NULL;
    glad_vkGetSemaphoreCounterValue = NULL;
    glad_vkResetQueryPool = NULL;
    glad_vkSignalSemaphore = NULL;
    glad_vkWaitSemaphores = NULL;
    glad_vkCmdBeginRendering = NULL;
    glad_vkCmdBindVertexBuffers2 = NULL;
    glad_vkCmdBlitImage2 = NULL;
    glad_vkCmdCopyBuffer2 = NULL;
    glad_vkCmdCopyBufferToImage2 = NULL;
    glad_vkCmdCopyImage2 = NULL;
    glad_vkCmdCopyImageToBuffer2 = NULL;
    glad_vkCmdEndRendering = NULL;
    glad_vkCmdPipelineBarrier2 = NULL;
    glad_vkCmdResetEvent2 = NULL;
    glad_vkCmdResolveImage2 = NULL;
    glad_vkCmdSetCullMode = NULL;
    glad_vkCmdSetDepthBiasEnable = NULL;
    glad_vkCmdSetDepthBoundsTestEnable = NULL;
    glad_vkCmdSetDepthCompareOp = NULL;
    glad_vkCmdSetDepthTestEnable = NULL;
    glad_vkCmdSetDepthWriteEnable = NULL;
    glad_vkCmdSetEvent2 = NULL;
    glad_vkCmdSetFrontFace = NULL;
    glad_vkCmdSetPrimitiveRestartEnable = NULL;
    glad_vkCmdSetPrimitiveTopology = NULL;
    glad_vkCmdSetRasterizerDiscardEnable = NULL;
    glad_vkCmdSetScissorWithCount = NULL;
    glad_vkCmdSetStencilOp = NULL;
    glad_vkCmdSetStencilTestEnable = NULL;
    glad_vkCmdSetViewportWithCount = NULL;
    glad_vkCmdWaitEvents2 = NULL;
    glad_vkCmdWriteTimestamp2 = NULL;
    glad_vkCreatePrivateDataSlot = NULL;
    glad_vkDestroyPrivateDataSlot = NULL;
    glad_vkGetDeviceBufferMemoryRequirements = NULL;
    glad_vkGetDeviceImageMemoryRequirements = NULL;
    glad_vkGetDeviceImageSparseMemoryRequirements = NULL;
    glad_vkGetPhysicalDeviceToolProperties = NULL;
    glad_vkGetPrivateData = NULL;
    glad_vkQueueSubmit2 = NULL;
    glad_vkSetPrivateData = NULL;
    glad_vkCmdWriteBufferMarkerAMD = NULL;
    glad_vkSetLocalDimmingAMD = NULL;
    glad_vkCmdDrawIndexedIndirectCountAMD = NULL;
    glad_vkCmdDrawIndirectCountAMD = NULL;
    glad_vkGetShaderInfoAMD = NULL;
#if defined(VK_USE_PLATFORM_ANDROID_KHR)
    glad_vkGetAndroidHardwareBufferPropertiesANDROID = NULL;

#endif
#if defined(VK_USE_PLATFORM_ANDROID_KHR)
    glad_vkGetMemoryAndroidHardwareBufferANDROID = NULL;

#endif
    glad_vkAcquireDrmDisplayEXT = NULL;
    glad_vkGetDrmDisplayEXT = NULL;
#if defined(VK_USE_PLATFORM_XLIB_XRANDR_EXT)
    glad_vkAcquireXlibDisplayEXT = NULL;

#endif
#if defined(VK_USE_PLATFORM_XLIB_XRANDR_EXT)
    glad_vkGetRandROutputDisplayEXT = NULL;

#endif
    glad_vkGetBufferDeviceAddressEXT = NULL;
    glad_vkGetCalibratedTimestampsEXT = NULL;
    glad_vkGetPhysicalDeviceCalibrateableTimeDomainsEXT = NULL;
    glad_vkCmdSetColorWriteEnableEXT = NULL;
    glad_vkCmdBeginConditionalRenderingEXT = NULL;
    glad_vkCmdEndConditionalRenderingEXT = NULL;
    glad_vkCmdDebugMarkerBeginEXT = NULL;
    glad_vkCmdDebugMarkerEndEXT = NULL;
    glad_vkCmdDebugMarkerInsertEXT = NULL;
    glad_vkDebugMarkerSetObjectNameEXT = NULL;
    glad_vkDebugMarkerSetObjectTagEXT = NULL;
    glad_vkCreateDebugReportCallbackEXT = NULL;
    glad_vkDebugReportMessageEXT = NULL;
    glad_vkDestroyDebugReportCallbackEXT = NULL;
    glad_vkCmdBeginDebugUtilsLabelEXT = NULL;
    glad_vkCmdEndDebugUtilsLabelEXT = NULL;
    glad_vkCmdInsertDebugUtilsLabelEXT = NULL;
    glad_vkCreateDebugUtilsMessengerEXT = NULL;
    glad_vkDestroyDebugUtilsMessengerEXT = NULL;
    glad_vkQueueBeginDebugUtilsLabelEXT = NULL;
    glad_vkQueueEndDebugUtilsLabelEXT = NULL;
    glad_vkQueueInsertDebugUtilsLabelEXT = NULL;
...
#if defined(VK_USE_PLATFORM_DIRECTFB_EXT)
    glad_vkCreateDirectFBSurfaceEXT = NULL;

#endif
#if defined(VK_USE_PLATFORM_DIRECTFB_EXT)
    glad_vkGetPhysicalDeviceDirectFBPresentationSupportEXT = NULL;

#endif
    glad_vkCmdSetDiscardRectangleEXT = NULL;
    glad_vkDisplayPowerControlEXT = NULL;
    glad_vkGetSwapchainCounterEXT = NULL;
    glad_vkRegisterDeviceEventEXT = NULL;
    glad_vkRegisterDisplayEventEXT = NULL;
    glad_vkGetPhysicalDeviceSurfaceCapabilities2EXT = NULL;
    glad_vkCmdBindVertexBuffers2EXT = NULL;
    glad_vkCmdSetCullModeEXT = NULL;
    glad_vkCmdSetDepthBoundsTestEnableEXT = NULL;
    glad_vkCmdSetDepthCompareOpEXT = NULL;
    glad_vkCmdSetDepthTestEnableEXT = NULL;
    glad_vkCmdSetDepthWriteEnableEXT = NULL;
    glad_vkCmdSetFrontFaceEXT = NULL;
    glad_vkCmdSetPrimitiveTopologyEXT = NULL;
    glad_vkCmdSetScissorWithCountEXT = NULL;
    glad_vkCmdSetStencilOpEXT = NULL;
    glad_vkCmdSetStencilTestEnableEXT = NULL;
    glad_vkCmdSetViewportWithCountEXT = NULL;
    glad_vkCmdSetDepthBiasEnableEXT = NULL;
    glad_vkCmdSetLogicOpEXT = NULL;
    glad_vkCmdSetPatchControlPointsEXT = NULL;
    glad_vkCmdSetPrimitiveRestartEnableEXT = NULL;
    glad_vkCmdSetRasterizerDiscardEnableEXT = NULL;
    glad_vkCmdSetAlphaToCoverageEnableEXT = NULL;
    glad_vkCmdSetAlphaToOneEnableEXT = NULL;
    glad_vkCmdSetColorBlendAdvancedEXT = NULL;
    glad_vkCmdSetColorBlendEnableEXT = NULL;
    glad_vkCmdSetColorBlendEquationEXT = NULL;
    glad_vkCmdSetColorWriteMaskEXT = NULL;
    glad_vkCmdSetConservativeRasterizationModeEXT = NULL;
    glad_vkCmdSetCoverageModulationModeNV = NULL;
    glad_vkCmdSetCoverageModulationTableEnableNV = NULL;
    glad_vkCmdSetCoverageModulationTableNV = NULL;
    glad_vkCmdSetCoverageReductionModeNV = NULL;
    glad_vkCmdSetCoverageToColorEnableNV = NULL;
    glad_vkCmdSetCoverageToColorLocationNV = NULL;
    glad_vkCmdSetDepthClampEnableEXT = NULL;
    glad_vkCmdSetDepthClipEnableEXT = NULL;
    glad_vkCmdSetDepthClipNegativeOneToOneEXT = NULL;
    glad_vkCmdSetExtraPrimitiveOverestimationSizeEXT = NULL;
    glad_vkCmdSetLineRasterizationModeEXT = NULL;
    glad_vkCmdSetLineStippleEnableEXT = NULL;
    glad_vkCmdSetLogicOpEnableEXT = NULL;
    glad_vkCmdSetPolygonModeEXT = NULL;
    glad_vkCmdSetProvokingVertexModeEXT = NULL;
    glad_vkCmdSetRasterizationSamplesEXT = NULL;
    glad_vkCmdSetRasterizationStreamEXT = NULL;
    glad_vkCmdSetRepresentativeFragmentTestEnableNV = NULL;
    glad_vkCmdSetSampleLocationsEnableEXT = NULL;
    glad_vkCmdSetSampleMaskEXT = NULL;
    glad_vkCmdSetShadingRateImageEnableNV = NULL;
    glad_vkCmdSetTessellationDomainOriginEXT = NULL;
    glad_vkCmdSetViewportSwizzleNV = NULL;
    glad_vkCmdSetViewportWScalingEnableNV = NULL;
    glad_vkGetMemoryHostPointerPropertiesEXT = NULL;
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    glad_vkAcquireFullScreenExclusiveModeEXT = NULL;

#endif
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    glad_vkGetDeviceGroupSurfacePresentModes2EXT = NULL;

#endif
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    glad_vkGetPhysicalDeviceSurfacePresentModes2EXT = NULL;

#endif
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    glad_vkReleaseFullScreenExclusiveModeEXT = NULL;

#endif
    glad_vkSetHdrMetadataEXT = NULL;
    glad_vkCreateHeadlessSurfaceEXT = NULL;
    glad_vkResetQueryPoolEXT = NULL;
    glad_vkGetImageSubresourceLayout2EXT = NULL;
    glad_vkGetImageDrmFormatModifierPropertiesEXT = NULL;
    glad_vkCmdSetLineStippleEXT = NULL;
    glad_vkCmdDrawMeshTasksEXT = NULL;
    glad_vkCmdDrawMeshTasksIndirectCountEXT = NULL;
    glad_vkCmdDrawMeshTasksIndirectEXT = NULL;
#if defined(VK_USE_PLATFORM_METAL_EXT)
    glad_vkExportMetalObjectsEXT = NULL;

#endif
#if defined(VK_USE_PLATFORM_METAL_EXT)
    glad_vkCreateMetalSurfaceEXT = NULL;

#endif
    glad_vkCmdDrawMultiEXT = NULL;
    glad_vkCmdDrawMultiIndexedEXT = NULL;
    glad_vkBuildMicromapsEXT = NULL;
    glad_vkCmdBuildMicromapsEXT = NULL;
    glad_vkCmdCopyMemoryToMicromapEXT = NULL;
    glad_vkCmdCopyMicromapEXT = NULL;
    glad_vkCmdCopyMicromapToMemoryEXT = NULL;
    glad_vkCmdWriteMicromapsPropertiesEXT = NULL;
    glad_vkCopyMemoryToMicromapEXT = NULL;
    glad_vkCopyMicromapEXT = NULL;
    glad_vkCopyMicromapToMemoryEXT = NULL;
    glad_vkCreateMicromapEXT = NULL;
    glad_vkDestroyMicromapEXT = NULL;
    glad_vkGetDeviceMicromapCompatibilityEXT = NULL;
    glad_vkGetMicromapBuildSizesEXT = NULL;
    glad_vkWriteMicromapsPropertiesEXT = NULL;
    glad_vkSetDeviceMemoryPriorityEXT = NULL;
    glad_vkGetPipelinePropertiesEXT = NULL;
    glad_vkCreatePrivateDataSlotEXT = NULL;
    glad_vkDestroyPrivateDataSlotEXT = NULL;
    glad_vkGetPrivateDataEXT = NULL;
    glad_vkSetPrivateDataEXT = NULL;
    glad_vkCmdSetSampleLocationsEXT = NULL;
    glad_vkGetPhysicalDeviceMultisamplePropertiesEXT = NULL;
    glad_vkGetShaderModuleCreateInfoIdentifierEXT = NULL;
    glad_vkGetShaderModuleIdentifierEXT = NULL;
    glad_vkGetPhysicalDeviceToolPropertiesEXT = NULL;
    glad_vkCmdBeginQueryIndexedEXT = NULL;
    glad_vkCmdBeginTransformFeedbackEXT = NULL;
    glad_vkCmdBindTransformFeedbackBuffersEXT = NULL;
    glad_vkCmdDrawIndirectByteCountEXT = NULL;
    glad_vkCmdEndQueryIndexedEXT = NULL;
    glad_vkCmdEndTransformFeedbackEXT = NULL;
    glad_vkCreateValidationCacheEXT = NULL;
    glad_vkDestroyValidationCacheEXT = NULL;
    glad_vkGetValidationCacheDataEXT = NULL;
    glad_vkMergeValidationCachesEXT = NULL;
    glad_vkCmdSetVertexInputEXT = NULL;
#if defined(VK_USE_PLATFORM_FUCHSIA)
    glad_vkCreateBufferCollectionFUCHSIA = NULL;

#endif
#if defined(VK_USE_PLATFORM_FUCHSIA)
    glad_vkDestroyBufferCollectionFUCHSIA = NULL;

#endif
#if defined(VK_USE_PLATFORM_FUCHSIA)
    glad_vkGetBufferCollectionPropertiesFUCHSIA = NULL;

#endif
#if defined(VK_USE_PLATFORM_FUCHSIA)
    glad_vkSetBufferCollectionBufferConstraintsFUCHSIA = NULL;

#endif
#if defined(VK_USE_PLATFORM_FUCHSIA)
    glad_vkSetBufferCollectionImageConstraintsFUCHSIA = NULL;

#endif
#if defined(VK_USE_PLATFORM_FUCHSIA)
    glad_vkGetMemoryZirconHandleFUCHSIA = NULL;

#endif
#if defined(VK_USE_PLATFORM_FUCHSIA)
    glad_vkGetMemoryZirconHandlePropertiesFUCHSIA = NULL;

#endif
#if defined(VK_USE_PLATFORM_FUCHSIA)
    glad_vkGetSemaphoreZirconHandleFUCHSIA = NULL;

#endif
#if defined(VK_USE_PLATFORM_FUCHSIA)
    glad_vkImportSemaphoreZirconHandleFUCHSIA = NULL;

#endif
#if defined(VK_USE_PLATFORM_FUCHSIA)
    glad_vkCreateImagePipeSurfaceFUCHSIA = NULL;

#endif
#if defined(VK_USE_PLATFORM_GGP)
    glad_vkCreateStreamDescriptorSurfaceGGP = NULL;

#endif
    glad_vkGetPastPresentationTimingGOOGLE = NULL;
    glad_vkGetRefreshCycleDurationGOOGLE = NULL;
    glad_vkCmdBindInvocationMaskHUAWEI = NULL;
    glad_vkCmdSubpassShadingHUAWEI = NULL;
    glad_vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI = NULL;
    glad_vkAcquirePerformanceConfigurationINTEL = NULL;
    glad_vkCmdSetPerformanceMarkerINTEL = NULL;
    glad_vkCmdSetPerformanceOverrideINTEL = NULL;
    glad_vkCmdSetPerformanceStreamMarkerINTEL = NULL;
    glad_vkGetPerformanceParameterINTEL = NULL;
    glad_vkInitializePerformanceApiINTEL = NULL;
    glad_vkQueueSetPerformanceConfigurationINTEL = NULL;
    glad_vkReleasePerformanceConfigurationINTEL = NULL;
    glad_vkUninitializePerformanceApiINTEL = NULL;
    glad_vkBuildAccelerationStructuresKHR = NULL;
    glad_vkCmdBuildAccelerationStructuresIndirectKHR = NULL;
    glad_vkCmdBuildAccelerationStructuresKHR = NULL;
    glad_vkCmdCopyAccelerationStructureKHR = NULL;
    glad_vkCmdCopyAccelerationStructureToMemoryKHR = NULL;
    glad_vkCmdCopyMemoryToAccelerationStructureKHR = NULL;
    glad_vkCmdWriteAccelerationStructuresPropertiesKHR = NULL;
    glad_vkCopyAccelerationStructureKHR = NULL;
    glad_vkCopyAccelerationStructureToMemoryKHR = NULL;
    glad_vkCopyMemoryToAccelerationStructureKHR = NULL;
    glad_vkCreateAccelerationStructureKHR = NULL;
    glad_vkDestroyAccelerationStructureKHR = NULL;
    glad_vkGetAccelerationStructureBuildSizesKHR = NULL;
    glad_vkGetAccelerationStructureDeviceAddressKHR = NULL;
    glad_vkGetDeviceAccelerationStructureCompatibilityKHR = NULL;
    glad_vkWriteAccelerationStructuresPropertiesKHR = NULL;
#if defined(VK_USE_PLATFORM_ANDROID_KHR)
    glad_vkCreateAndroidSurfaceKHR = NULL;

#endif
    glad_vkBindBufferMemory2KHR = NULL;
    glad_vkBindImageMemory2KHR = NULL;
    glad_vkGetBufferDeviceAddressKHR = NULL;
    glad_vkGetBufferOpaqueCaptureAddressKHR = NULL;
    glad_vkGetDeviceMemoryOpaqueCaptureAddressKHR = NULL;
    glad_vkCmdBlitImage2KHR = NULL;
    glad_vkCmdCopyBuffer2KHR = NULL;
    glad_vkCmdCopyBufferToImage2KHR = NULL;
    glad_vkCmdCopyImage2KHR = NULL;
    glad_vkCmdCopyImageToBuffer2KHR = NULL;
    glad_vkCmdResolveImage2KHR = NULL;
    glad_vkCmdBeginRenderPass2KHR = NULL;
    glad_vkCmdEndRenderPass2KHR = NULL;
    glad_vkCmdNextSubpass2KHR = NULL;
    glad_vkCreateRenderPass2KHR = NULL;
    glad_vkCreateDeferredOperationKHR = NULL;
    glad_vkDeferredOperationJoinKHR = NULL;
    glad_vkDestroyDeferredOperationKHR = NULL;
    glad_vkGetDeferredOperationMaxConcurrencyKHR = NULL;
    glad_vkGetDeferredOperationResultKHR = NULL;
    glad_vkCmdPushDescriptorSetWithTemplateKHR = NULL;
    glad_vkCreateDescriptorUpdateTemplateKHR = NULL;
    glad_vkDestroyDescriptorUpdateTemplateKHR = NULL;
    glad_vkUpdateDescriptorSetWithTemplateKHR = NULL;
    glad_vkAcquireNextImage2KHR = NULL;
    glad_vkCmdDispatchBaseKHR = NULL;
    glad_vkCmdSetDeviceMaskKHR = NULL;
    ...
    glad_vkEnumeratePhysicalDeviceGroupsKHR = NULL;
    glad_vkCreateDisplayModeKHR = NULL;
    glad_vkCreateDisplayPlaneSurfaceKHR = NULL;
    glad_vkGetDisplayModePropertiesKHR = NULL;
    glad_vkGetDisplayPlaneCapabilitiesKHR = NULL;
    glad_vkGetDisplayPlaneSupportedDisplaysKHR = NULL;
    glad_vkGetPhysicalDeviceDisplayPlanePropertiesKHR = NULL;
    glad_vkGetPhysicalDeviceDisplayPropertiesKHR = NULL;
    glad_vkCreateSharedSwapchainsKHR = NULL;
    glad_vkCmdDrawIndexedIndirectCountKHR = NULL;
    glad_vkCmdDrawIndirectCountKHR = NULL;
    glad_vkCmdBeginRenderingKHR = NULL;
    glad_vkCmdEndRenderingKHR = NULL;
    glad_vkGetPhysicalDeviceExternalFencePropertiesKHR = NULL;
    glad_vkGetFenceFdKHR = NULL;
    glad_vkImportFenceFdKHR = NULL;
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    glad_vkGetFenceWin32HandleKHR = NULL;

#endif
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    glad_vkImportFenceWin32HandleKHR = NULL;

#endif
    glad_vkGetPhysicalDeviceExternalBufferPropertiesKHR = NULL;
    glad_vkGetMemoryFdKHR = NULL;
    glad_vkGetMemoryFdPropertiesKHR = NULL;
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    glad_vkGetMemoryWin32HandleKHR = NULL;

#endif
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    glad_vkGetMemoryWin32HandlePropertiesKHR = NULL;

#endif
    glad_vkGetPhysicalDeviceExternalSemaphorePropertiesKHR = NULL;
    glad_vkGetSemaphoreFdKHR = NULL;
    glad_vkImportSemaphoreFdKHR = NULL;
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    glad_vkGetSemaphoreWin32HandleKHR = NULL;

#endif
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    glad_vkImportSemaphoreWin32HandleKHR = NULL;

#endif
    glad_vkCmdSetFragmentShadingRateKHR = NULL;
    glad_vkGetPhysicalDeviceFragmentShadingRatesKHR = NULL;
    glad_vkGetDisplayModeProperties2KHR = NULL;
    glad_vkGetDisplayPlaneCapabilities2KHR = NULL;
    glad_vkGetPhysicalDeviceDisplayPlaneProperties2KHR = NULL;
    glad_vkGetPhysicalDeviceDisplayProperties2KHR = NULL;
    glad_vkGetBufferMemoryRequirements2KHR = NULL;
    glad_vkGetImageMemoryRequirements2KHR = NULL;
    glad_vkGetImageSparseMemoryRequirements2KHR = NULL;
    glad_vkGetPhysicalDeviceFeatures2KHR = NULL;
    glad_vkGetPhysicalDeviceFormatProperties2KHR = NULL;
    glad_vkGetPhysicalDeviceImageFormatProperties2KHR = NULL;
    glad_vkGetPhysicalDeviceMemoryProperties2KHR = NULL;
    glad_vkGetPhysicalDeviceProperties2KHR = NULL;
    glad_vkGetPhysicalDeviceQueueFamilyProperties2KHR = NULL;
    glad_vkGetPhysicalDeviceSparseImageFormatProperties2KHR = NULL;
    glad_vkGetPhysicalDeviceSurfaceCapabilities2KHR = NULL;
    glad_vkGetPhysicalDeviceSurfaceFormats2KHR = NULL;
    glad_vkTrimCommandPoolKHR = NULL;
    glad_vkGetDescriptorSetLayoutSupportKHR = NULL;
    glad_vkGetDeviceBufferMemoryRequirementsKHR = NULL;
    glad_vkGetDeviceImageMemoryRequirementsKHR = NULL;
    glad_vkGetDeviceImageSparseMemoryRequirementsKHR = NULL;
    glad_vkAcquireProfilingLockKHR = NULL;
    glad_vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR = NULL;
    glad_vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR = NULL;
    glad_vkReleaseProfilingLockKHR = NULL;
    glad_vkGetPipelineExecutableInternalRepresentationsKHR = NULL;
    glad_vkGetPipelineExecutablePropertiesKHR = NULL;
    glad_vkGetPipelineExecutableStatisticsKHR = NULL;
    glad_vkWaitForPresentKHR = NULL;
    glad_vkCmdPushDescriptorSetKHR = NULL;
    glad_vkCmdPushDescriptorSetWithTemplateKHR = NULL;
    glad_vkCmdTraceRaysIndirect2KHR = NULL;
    glad_vkCmdSetRayTracingPipelineStackSizeKHR = NULL;
    glad_vkCmdTraceRaysIndirectKHR = NULL;
    glad_vkCmdTraceRaysKHR = NULL;
    glad_vkCreateRayTracingPipelinesKHR = NULL;
    glad_vkGetRayTracingCaptureReplayShaderGroupHandlesKHR = NULL;
    glad_vkGetRayTracingShaderGroupHandlesKHR = NULL;
    glad_vkGetRayTracingShaderGroupStackSizeKHR = NULL;
    glad_vkCreateSamplerYcbcrConversionKHR = NULL;
    glad_vkDestroySamplerYcbcrConversionKHR = NULL;
    glad_vkGetSwapchainStatusKHR = NULL;
    glad_vkDestroySurfaceKHR = NULL;
    ...
    glad_vkAcquireNextImage2KHR = NULL;
    glad_vkAcquireNextImageKHR = NULL;
    glad_vkCreateSwapchainKHR = NULL;
    glad_vkDestroySwapchainKHR = NULL;
    glad_vkGetDeviceGroupPresentCapabilitiesKHR = NULL;
    glad_vkGetDeviceGroupSurfacePresentModesKHR = NULL;
    glad_vkGetPhysicalDevicePresentRectanglesKHR = NULL;
    glad_vkGetSwapchainImagesKHR = NULL;
    glad_vkQueuePresentKHR = NULL;
    glad_vkCmdPipelineBarrier2KHR = NULL;
    glad_vkCmdResetEvent2KHR = NULL;
    glad_vkCmdSetEvent2KHR = NULL;
    glad_vkCmdWaitEvents2KHR = NULL;
    glad_vkCmdWriteBufferMarker2AMD = NULL;
    glad_vkCmdWriteTimestamp2KHR = NULL;
    glad_vkGetQueueCheckpointData2NV = NULL;
    glad_vkQueueSubmit2KHR = NULL;
    glad_vkGetSemaphoreCounterValueKHR = NULL;
    glad_vkSignalSemaphoreKHR = NULL;
    glad_vkWaitSemaphoresKHR = NULL;
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    glad_vkCmdDecodeVideoKHR = NULL;

#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    glad_vkCmdEncodeVideoKHR = NULL;

#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    glad_vkBindVideoSessionMemoryKHR = NULL;

#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    glad_vkCmdBeginVideoCodingKHR = NULL;

#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    glad_vkCmdControlVideoCodingKHR = NULL;

#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    glad_vkCmdEndVideoCodingKHR = NULL;

#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    glad_vkCreateVideoSessionKHR = NULL;

#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    glad_vkCreateVideoSessionParametersKHR = NULL;

#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    glad_vkDestroyVideoSessionKHR = NULL;

#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    glad_vkDestroyVideoSessionParametersKHR = NULL;

#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    glad_vkGetPhysicalDeviceVideoCapabilitiesKHR = NULL;

#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    glad_vkGetPhysicalDeviceVideoFormatPropertiesKHR = NULL;

#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    glad_vkGetVideoSessionMemoryRequirementsKHR = NULL;

#endif
#if defined(VK_ENABLE_BETA_EXTENSIONS)
    glad_vkUpdateVideoSessionParametersKHR = NULL;

#endif
#if defined(VK_USE_PLATFORM_WAYLAND_KHR)
    glad_vkCreateWaylandSurfaceKHR = NULL;

#endif
#if defined(VK_USE_PLATFORM_WAYLAND_KHR)
    glad_vkGetPhysicalDeviceWaylandPresentationSupportKHR = NULL;

#endif
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    glad_vkCreateWin32SurfaceKHR = NULL;

#endif
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    glad_vkGetPhysicalDeviceWin32PresentationSupportKHR = NULL;

#endif
#if defined(VK_USE_PLATFORM_XCB_KHR)
    glad_vkCreateXcbSurfaceKHR = NULL;

#endif
#if defined(VK_USE_PLATFORM_XCB_KHR)
    glad_vkGetPhysicalDeviceXcbPresentationSupportKHR = NULL;

#endif
#if defined(VK_USE_PLATFORM_XLIB_KHR)
    glad_vkCreateXlibSurfaceKHR = NULL;

#endif
#if defined(VK_USE_PLATFORM_XLIB_KHR)
    glad_vkGetPhysicalDeviceXlibPresentationSupportKHR = NULL;

#endif
#if defined(VK_USE_PLATFORM_IOS_MVK)
    glad_vkCreateIOSSurfaceMVK = NULL;

#endif
#if defined(VK_USE_PLATFORM_MACOS_MVK)
    glad_vkCreateMacOSSurfaceMVK = NULL;

#endif
#if defined(VK_USE_PLATFORM_VI_NN)
    glad_vkCreateViSurfaceNN = NULL;

#endif
    glad_vkCmdCuLaunchKernelNVX = NULL;
    glad_vkCreateCuFunctionNVX = NULL;
    glad_vkCreateCuModuleNVX = NULL;
    glad_vkDestroyCuFunctionNVX = NULL;
    glad_vkDestroyCuModuleNVX = NULL;
    glad_vkGetImageViewAddressNVX = NULL;
    glad_vkGetImageViewHandleNVX = NULL;
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    glad_vkAcquireWinrtDisplayNV = NULL;

#endif
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    glad_vkGetWinrtDisplayNV = NULL;
    ...
    glad_vkCmdBindPipelineShaderGroupNV = NULL;
    glad_vkCmdExecuteGeneratedCommandsNV = NULL;
    glad_vkCmdPreprocessGeneratedCommandsNV = NULL;
    glad_vkCreateIndirectCommandsLayoutNV = NULL;
    glad_vkDestroyIndirectCommandsLayoutNV = NULL;
    glad_vkGetGeneratedCommandsMemoryRequirementsNV = NULL;
    glad_vkGetPhysicalDeviceExternalImageFormatPropertiesNV = NULL;
    glad_vkGetMemoryRemoteAddressNV = NULL;
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    glad_vkGetMemoryWin32HandleNV = NULL;
    ...
    glad_vkBindOpticalFlowSessionImageNV = NULL;
    glad_vkCmdOpticalFlowExecuteNV = NULL;
    glad_vkCreateOpticalFlowSessionNV = NULL;
    glad_vkDestroyOpticalFlowSessionNV = NULL;
    glad_vkGetPhysicalDeviceOpticalFlowImageFormatsNV = NULL;
    glad_vkBindAccelerationStructureMemoryNV = NULL;
    glad_vkCmdBuildAccelerationStructureNV = NULL;
    glad_vkCmdCopyAccelerationStructureNV = NULL;
    glad_vkCmdTraceRaysNV = NULL;
    glad_vkCmdWriteAccelerationStructuresPropertiesNV = NULL;
    glad_vkCompileDeferredNV = NULL;
    glad_vkCreateAccelerationStructureNV = NULL;
    glad_vkCreateRayTracingPipelinesNV = NULL;
    glad_vkDestroyAccelerationStructureNV = NULL;
    glad_vkGetAccelerationStructureHandleNV = NULL;
    glad_vkGetAccelerationStructureMemoryRequirementsNV = NULL;
    glad_vkGetRayTracingShaderGroupHandlesNV = NULL;
    glad_vkCmdSetExclusiveScissorNV = NULL;
    glad_vkCmdBindShadingRateImageNV = NULL;
    glad_vkCmdSetCoarseSampleOrderNV = NULL;
    glad_vkCmdSetViewportShadingRatePaletteNV = NULL;
    glad_vkGetDynamicRenderingTilePropertiesQCOM = NULL;
    glad_vkGetFramebufferTilePropertiesQCOM = NULL;
#if defined(VK_USE_PLATFORM_SCREEN_QNX)
    glad_vkCreateScreenSurfaceQNX = NULL;

#endif
#if defined(VK_USE_PLATFORM_SCREEN_QNX)
    glad_vkGetPhysicalDeviceScreenPresentationSupportQNX = NULL;

#endif
    glad_vkGetDescriptorSetHostMappingVALVE = NULL;
    glad_vkGetDescriptorSetLayoutHostMappingInfoVALVE = NULL;
}
