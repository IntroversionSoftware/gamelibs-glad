...
static void glad_gl_load_GL_ANGLE_memory_object_flags(GladGLContext *context, GLADuserptrloadfunc load, void* userptr) {
    ...
    context->TexStorageMemFlags2DMultisampleANGLE = (PFNGLTEXSTORAGEMEMFLAGS2DMULTISAMPLEANGLEPROC) load(userptr, "glTexStorageMemFlags2DMultisampleANGLE");
...
static void glad_gl_load_GL_ANGLE_base_vertex_base_instance(GladGLContext *context, GLADuserptrloadfunc load, void* userptr) {
    ...
    context->DrawElementsInstancedBaseVertexBaseInstanceANGLE = (PFNGLDRAWELEMENTSINSTANCEDBASEVERTEXBASEINSTANCEANGLEPROC) load(userptr, "glDrawElementsInstancedBaseVertexBaseInstanceANGLE");
...
static void glad_gl_load_GL_ANGLE_multi_draw(GladGLContext *context, GLADuserptrloadfunc load, void* userptr) {
    ...
    context->MultiDrawArraysInstancedANGLE = (PFNGLMULTIDRAWARRAYSINSTANCEDANGLEPROC) load(userptr, "glMultiDrawArraysInstancedANGLE");
...
static void glad_gl_load_GL_ANGLE_robust_client_memory(GladGLContext *context, GLADuserptrloadfunc load, void* userptr) {
    ...
    context->CompressedTexImage3DRobustANGLE = (PFNGLCOMPRESSEDTEXIMAGE3DROBUSTANGLEPROC) load(userptr, "glCompressedTexImage3DRobustANGLE");
    context->CompressedTexSubImage2DRobustANGLE = (PFNGLCOMPRESSEDTEXSUBIMAGE2DROBUSTANGLEPROC) load(userptr, "glCompressedTexSubImage2DRobustANGLE");
    context->CompressedTexSubImage3DRobustANGLE = (PFNGLCOMPRESSEDTEXSUBIMAGE3DROBUSTANGLEPROC) load(userptr, "glCompressedTexSubImage3DRobustANGLE");
    context->GetActiveUniformBlockivRobustANGLE = (PFNGLGETACTIVEUNIFORMBLOCKIVROBUSTANGLEPROC) load(userptr, "glGetActiveUniformBlockivRobustANGLE");
    context->GetBooleani_vRobustANGLE = (PFNGLGETBOOLEANI_VROBUSTANGLEPROC) load(userptr, "glGetBooleani_vRobustANGLE");
    context->GetBooleanvRobustANGLE = (PFNGLGETBOOLEANVROBUSTANGLEPROC) load(userptr, "glGetBooleanvRobustANGLE");
    context->GetBufferParameteri64vRobustANGLE = (PFNGLGETBUFFERPARAMETERI64VROBUSTANGLEPROC) load(userptr, "glGetBufferParameteri64vRobustANGLE");
    context->GetBufferParameterivRobustANGLE = (PFNGLGETBUFFERPARAMETERIVROBUSTANGLEPROC) load(userptr, "glGetBufferParameterivRobustANGLE");
    context->GetBufferPointervRobustANGLE = (PFNGLGETBUFFERPOINTERVROBUSTANGLEPROC) load(userptr, "glGetBufferPointervRobustANGLE");
    context->GetFloatvRobustANGLE = (PFNGLGETFLOATVROBUSTANGLEPROC) load(userptr, "glGetFloatvRobustANGLE");
    context->GetFramebufferAttachmentParameterivRobustANGLE = (PFNGLGETFRAMEBUFFERATTACHMENTPARAMETERIVROBUSTANGLEPROC) load(userptr, "glGetFramebufferAttachmentParameterivRobustANGLE");
    context->GetFramebufferParameterivRobustANGLE = (PFNGLGETFRAMEBUFFERPARAMETERIVROBUSTANGLEPROC) load(userptr, "glGetFramebufferParameterivRobustANGLE");
    context->GetInteger64i_vRobustANGLE = (PFNGLGETINTEGER64I_VROBUSTANGLEPROC) load(userptr, "glGetInteger64i_vRobustANGLE");
    context->GetInteger64vRobustANGLE = (PFNGLGETINTEGER64VROBUSTANGLEPROC) load(userptr, "glGetInteger64vRobustANGLE");
    context->GetIntegeri_vRobustANGLE = (PFNGLGETINTEGERI_VROBUSTANGLEPROC) load(userptr, "glGetIntegeri_vRobustANGLE");
    context->GetIntegervRobustANGLE = (PFNGLGETINTEGERVROBUSTANGLEPROC) load(userptr, "glGetIntegervRobustANGLE");
    context->GetInternalformativRobustANGLE = (PFNGLGETINTERNALFORMATIVROBUSTANGLEPROC) load(userptr, "glGetInternalformativRobustANGLE");
    context->GetMultisamplefvRobustANGLE = (PFNGLGETMULTISAMPLEFVROBUSTANGLEPROC) load(userptr, "glGetMultisamplefvRobustANGLE");
    context->GetPointervRobustANGLERobustANGLE = (PFNGLGETPOINTERVROBUSTANGLEROBUSTANGLEPROC) load(userptr, "glGetPointervRobustANGLERobustANGLE");
    context->GetProgramInterfaceivRobustANGLE = (PFNGLGETPROGRAMINTERFACEIVROBUSTANGLEPROC) load(userptr, "glGetProgramInterfaceivRobustANGLE");
    context->GetProgramivRobustANGLE = (PFNGLGETPROGRAMIVROBUSTANGLEPROC) load(userptr, "glGetProgramivRobustANGLE");
    context->GetQueryObjecti64vRobustANGLE = (PFNGLGETQUERYOBJECTI64VROBUSTANGLEPROC) load(userptr, "glGetQueryObjecti64vRobustANGLE");
    context->GetQueryObjectivRobustANGLE = (PFNGLGETQUERYOBJECTIVROBUSTANGLEPROC) load(userptr, "glGetQueryObjectivRobustANGLE");
    context->GetQueryObjectui64vRobustANGLE = (PFNGLGETQUERYOBJECTUI64VROBUSTANGLEPROC) load(userptr, "glGetQueryObjectui64vRobustANGLE");
    context->GetQueryObjectuivRobustANGLE = (PFNGLGETQUERYOBJECTUIVROBUSTANGLEPROC) load(userptr, "glGetQueryObjectuivRobustANGLE");
    context->GetQueryivRobustANGLE = (PFNGLGETQUERYIVROBUSTANGLEPROC) load(userptr, "glGetQueryivRobustANGLE");
    context->GetRenderbufferParameterivRobustANGLE = (PFNGLGETRENDERBUFFERPARAMETERIVROBUSTANGLEPROC) load(userptr, "glGetRenderbufferParameterivRobustANGLE");
    context->GetSamplerParameterIivRobustANGLE = (PFNGLGETSAMPLERPARAMETERIIVROBUSTANGLEPROC) load(userptr, "glGetSamplerParameterIivRobustANGLE");
    context->GetSamplerParameterIuivRobustANGLE = (PFNGLGETSAMPLERPARAMETERIUIVROBUSTANGLEPROC) load(userptr, "glGetSamplerParameterIuivRobustANGLE");
    context->GetSamplerParameterfvRobustANGLE = (PFNGLGETSAMPLERPARAMETERFVROBUSTANGLEPROC) load(userptr, "glGetSamplerParameterfvRobustANGLE");
    context->GetSamplerParameterivRobustANGLE = (PFNGLGETSAMPLERPARAMETERIVROBUSTANGLEPROC) load(userptr, "glGetSamplerParameterivRobustANGLE");
    context->GetShaderivRobustANGLE = (PFNGLGETSHADERIVROBUSTANGLEPROC) load(userptr, "glGetShaderivRobustANGLE");
    context->GetTexLevelParameterfvRobustANGLE = (PFNGLGETTEXLEVELPARAMETERFVROBUSTANGLEPROC) load(userptr, "glGetTexLevelParameterfvRobustANGLE");
    context->GetTexLevelParameterivRobustANGLE = (PFNGLGETTEXLEVELPARAMETERIVROBUSTANGLEPROC) load(userptr, "glGetTexLevelParameterivRobustANGLE");
    context->GetTexParameterIivRobustANGLE = (PFNGLGETTEXPARAMETERIIVROBUSTANGLEPROC) load(userptr, "glGetTexParameterIivRobustANGLE");
    context->GetTexParameterIuivRobustANGLE = (PFNGLGETTEXPARAMETERIUIVROBUSTANGLEPROC) load(userptr, "glGetTexParameterIuivRobustANGLE");
    context->GetTexParameterfvRobustANGLE = (PFNGLGETTEXPARAMETERFVROBUSTANGLEPROC) load(userptr, "glGetTexParameterfvRobustANGLE");
    context->GetTexParameterivRobustANGLE = (PFNGLGETTEXPARAMETERIVROBUSTANGLEPROC) load(userptr, "glGetTexParameterivRobustANGLE");
    context->GetUniformfvRobustANGLE = (PFNGLGETUNIFORMFVROBUSTANGLEPROC) load(userptr, "glGetUniformfvRobustANGLE");
    context->GetUniformivRobustANGLE = (PFNGLGETUNIFORMIVROBUSTANGLEPROC) load(userptr, "glGetUniformivRobustANGLE");
    context->GetUniformuivRobustANGLE = (PFNGLGETUNIFORMUIVROBUSTANGLEPROC) load(userptr, "glGetUniformuivRobustANGLE");
    context->GetVertexAttribIivRobustANGLE = (PFNGLGETVERTEXATTRIBIIVROBUSTANGLEPROC) load(userptr, "glGetVertexAttribIivRobustANGLE");
    context->GetVertexAttribIuivRobustANGLE = (PFNGLGETVERTEXATTRIBIUIVROBUSTANGLEPROC) load(userptr, "glGetVertexAttribIuivRobustANGLE");
    context->GetVertexAttribPointervRobustANGLE = (PFNGLGETVERTEXATTRIBPOINTERVROBUSTANGLEPROC) load(userptr, "glGetVertexAttribPointervRobustANGLE");
    context->GetVertexAttribfvRobustANGLE = (PFNGLGETVERTEXATTRIBFVROBUSTANGLEPROC) load(userptr, "glGetVertexAttribfvRobustANGLE");
    context->GetVertexAttribivRobustANGLE = (PFNGLGETVERTEXATTRIBIVROBUSTANGLEPROC) load(userptr, "glGetVertexAttribivRobustANGLE");
    context->GetnUniformfvRobustANGLE = (PFNGLGETNUNIFORMFVROBUSTANGLEPROC) load(userptr, "glGetnUniformfvRobustANGLE");
    context->GetnUniformivRobustANGLE = (PFNGLGETNUNIFORMIVROBUSTANGLEPROC) load(userptr, "glGetnUniformivRobustANGLE");
    context->GetnUniformuivRobustANGLE = (PFNGLGETNUNIFORMUIVROBUSTANGLEPROC) load(userptr, "glGetnUniformuivRobustANGLE");
    context->ReadPixelsRobustANGLE = (PFNGLREADPIXELSROBUSTANGLEPROC) load(userptr, "glReadPixelsRobustANGLE");
    context->ReadnPixelsRobustANGLE = (PFNGLREADNPIXELSROBUSTANGLEPROC) load(userptr, "glReadnPixelsRobustANGLE");
    context->SamplerParameterIivRobustANGLE = (PFNGLSAMPLERPARAMETERIIVROBUSTANGLEPROC) load(userptr, "glSamplerParameterIivRobustANGLE");
    context->SamplerParameterIuivRobustANGLE = (PFNGLSAMPLERPARAMETERIUIVROBUSTANGLEPROC) load(userptr, "glSamplerParameterIuivRobustANGLE");
    context->SamplerParameterfvRobustANGLE = (PFNGLSAMPLERPARAMETERFVROBUSTANGLEPROC) load(userptr, "glSamplerParameterfvRobustANGLE");
    context->SamplerParameterivRobustANGLE = (PFNGLSAMPLERPARAMETERIVROBUSTANGLEPROC) load(userptr, "glSamplerParameterivRobustANGLE");
    context->TexImage2DRobustANGLE = (PFNGLTEXIMAGE2DROBUSTANGLEPROC) load(userptr, "glTexImage2DRobustANGLE");
    context->TexImage3DRobustANGLE = (PFNGLTEXIMAGE3DROBUSTANGLEPROC) load(userptr, "glTexImage3DRobustANGLE");
    context->TexParameterIivRobustANGLE = (PFNGLTEXPARAMETERIIVROBUSTANGLEPROC) load(userptr, "glTexParameterIivRobustANGLE");
    context->TexParameterIuivRobustANGLE = (PFNGLTEXPARAMETERIUIVROBUSTANGLEPROC) load(userptr, "glTexParameterIuivRobustANGLE");
    context->TexParameterfvRobustANGLE = (PFNGLTEXPARAMETERFVROBUSTANGLEPROC) load(userptr, "glTexParameterfvRobustANGLE");
...
static void glad_gl_resolve_aliases(GladGLContext *context) {
    ...
    if (context->ProvokingVertex == NULL && context->ProvokingVertexANGLE != NULL) context->ProvokingVertex = (PFNGLPROVOKINGVERTEXPROC)context->ProvokingVertexANGLE;
    ...
    if (context->ProvokingVertexANGLE == NULL && context->ProvokingVertex != NULL) context->ProvokingVertexANGLE = (PFNGLPROVOKINGVERTEXANGLEPROC)context->ProvokingVertex;
    if (context->ProvokingVertexANGLE == NULL && context->ProvokingVertexEXT != NULL) context->ProvokingVertexANGLE = (PFNGLPROVOKINGVERTEXANGLEPROC)context->ProvokingVertexEXT;
    ...
    if (context->ProvokingVertexEXT == NULL && context->ProvokingVertexANGLE != NULL) context->ProvokingVertexEXT = (PFNGLPROVOKINGVERTEXEXTPROC)context->ProvokingVertexANGLE;
...
static int glad_gl_find_extensions_gl(GladGLContext *context, int version) {
    ...
    context->AMD_shader_fragment_mask = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_AMD_shader_fragment_mask");
    ...
    context->EXT_buffer_reference = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_buffer_reference");
    context->EXT_buffer_reference2 = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_buffer_reference2");
    ...
    context->EXT_control_flow_attributes = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_control_flow_attributes");
    ...
    context->EXT_debug_printf = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_debug_printf");
    context->EXT_demote_to_helper_invocation = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_demote_to_helper_invocation");
    context->EXT_depth_bounds_test = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_depth_bounds_test");
    context->EXT_device_group = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_device_group");
    ...
    context->EXT_nonuniform_qualifier = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_nonuniform_qualifier");
    ...
    context->EXT_ray_cull_mask = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_ray_cull_mask");
    context->EXT_ray_flags_primitive_culling = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_ray_flags_primitive_culling");
    context->EXT_ray_query = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_ray_query");
    context->EXT_ray_tracing = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_ray_tracing");
    context->EXT_rescale_normal = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_rescale_normal");
    context->EXT_samplerless_texture_functions = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_samplerless_texture_functions");
    context->EXT_scalar_block_layout = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_scalar_block_layout");
    ...
    context->EXT_shader_16bit_storage = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_shader_16bit_storage");
    context->EXT_shader_atomic_float = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_shader_atomic_float");
    context->EXT_shader_explicit_arithmetic_types = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_shader_explicit_arithmetic_types");
    ...
    context->EXT_shader_image_int64 = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_shader_image_int64");
    ...
    context->EXT_shader_realtime_clock = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_shader_realtime_clock");
    ...
    context->EXT_shader_subgroup_extended_types = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_shader_subgroup_extended_types");
    context->EXT_shadow_funcs = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_shadow_funcs");
    context->EXT_shared_memory_block = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_shared_memory_block");
    ...
    context->EXT_subgroup_uniform_control_flow = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_subgroup_uniform_control_flow");
    context->EXT_subgroupuniform_qualifier = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_subgroupuniform_qualifier");
    ...
    context->EXT_vulkan_glsl_relaxed = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_vulkan_glsl_relaxed");
    ...
    context->HUAWEI_subpass_shading = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_HUAWEI_subpass_shading");
    ...
    context->KHR_memory_scope_semantics = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_KHR_memory_scope_semantics");
    ...
    context->KHR_vulkan_glsl = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_KHR_vulkan_glsl");
    ...
    context->NVX_multiview_per_view_attributes = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_NVX_multiview_per_view_attributes");
    ...
    context->NV_cooperative_matrix = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_NV_cooperative_matrix");
    ...
    context->NV_ray_tracing = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_NV_ray_tracing");
    context->NV_ray_tracing_motion_blur = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_NV_ray_tracing_motion_blur");
    ...
    context->NV_shader_sm_builtins = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_NV_shader_sm_builtins");
...
static int glad_gl_find_extensions_gles2(GladGLContext *context, int version) {
    ...
    context->CHROMIUM_bind_uniform_location = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_CHROMIUM_bind_uniform_location");
    context->CHROMIUM_copy_compressed_texture = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_CHROMIUM_copy_compressed_texture");
    context->CHROMIUM_copy_texture = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_CHROMIUM_copy_texture");
    context->CHROMIUM_framebuffer_mixed_samples = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_CHROMIUM_framebuffer_mixed_samples");
    context->CHROMIUM_lose_context = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_CHROMIUM_lose_context");
    ...
    context->EXT_EGL_image_storage_compression = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_EGL_image_storage_compression");
    ...
    context->EXT_separate_depth_stencil = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_separate_depth_stencil");
    ...
    context->EXT_texture_storage_compression = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_EXT_texture_storage_compression");
    ...
    context->QCOM_frame_extrapolation = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_QCOM_frame_extrapolation");
