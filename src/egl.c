...
GladEGLContext* glad_egl_context = NULL;
...
static int glad_egl_get_extensions(GladEGLContext *context, EGLDisplay display, const char **extensions) {
    *extensions = context->QueryString(display, EGL_EXTENSIONS);
