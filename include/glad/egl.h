/**
 * Loader generated by glad 2.0.2 on Wed Nov  2 04:41:29 2022
 *
...
typedef struct GladEGLContext {
    ...
    int VERSION_1_4;
    int VERSION_1_5;
    int ANDROID_GLES_layers;
    int ANDROID_blob_cache;
    int ANDROID_create_native_client_buffer;
    int ANDROID_framebuffer_target;
    int ANDROID_front_buffer_auto_refresh;
    int ANDROID_get_frame_timestamps;
    int ANDROID_get_native_client_buffer;
    int ANDROID_image_native_buffer;
    int ANDROID_native_fence_sync;
    int ANDROID_presentation_time;
    int ANDROID_recordable;
    int ANGLE_colorspace_attribute_passthrough;
    int ANGLE_context_virtualization;
    int ANGLE_create_context_backwards_compatible;
    int ANGLE_create_context_client_arrays;
    int ANGLE_create_context_extensions_enabled;
    int ANGLE_create_context_webgl_compatibility;
    int ANGLE_create_surface_swap_interval;
    int ANGLE_d3d_share_handle_client_buffer;
    int ANGLE_device_cgl;
    int ANGLE_device_creation;
    int ANGLE_device_d3d;
    int ANGLE_device_eagl;
    int ANGLE_device_metal;
    int ANGLE_device_vulkan;
    int ANGLE_direct_composition;
    int ANGLE_display_power_preference;
    int ANGLE_display_semaphore_share_group;
    int ANGLE_display_texture_share_group;
    int ANGLE_experimental_present_path;
    int ANGLE_feature_control;
    int ANGLE_ggp_stream_descriptor;
    int ANGLE_iosurface_client_buffer;
    int ANGLE_keyed_mutex;
    int ANGLE_metal_create_context_ownership_identity;
    int ANGLE_metal_shared_event_sync;
    int ANGLE_metal_texture_client_buffer;
    int ANGLE_platform_angle;
    int ANGLE_platform_angle_d3d;
    int ANGLE_platform_angle_d3d11on12;
    int ANGLE_platform_angle_d3d_luid;
    int ANGLE_platform_angle_device_context_volatile_cgl;
    int ANGLE_platform_angle_device_context_volatile_eagl;
    int ANGLE_platform_angle_device_id;
    int ANGLE_platform_angle_device_type_egl;
    int ANGLE_platform_angle_device_type_swiftshader;
    int ANGLE_platform_angle_metal;
    int ANGLE_platform_angle_null;
    int ANGLE_platform_angle_opengl;
    int ANGLE_platform_angle_vulkan;
    int ANGLE_power_preference;
    int ANGLE_prepare_swap_buffers;
    int ANGLE_program_cache_control;
    int ANGLE_query_surface_pointer;
    int ANGLE_robust_resource_initialization;
    int ANGLE_stream_producer_d3d_texture;
    int ANGLE_surface_d3d_texture_2d_share_handle;
    int ANGLE_surface_orientation;
    int ANGLE_swap_with_frame_token;
    int ANGLE_sync_control_rate;
    int ANGLE_vulkan_display;
    int ANGLE_vulkan_image;
    int ANGLE_window_fixed_size;
    int ARM_image_format;
    int ARM_implicit_external_sync;
    int ARM_pixmap_multisample_discard;
    int CHROMIUM_sync_control;
    int EXT_bind_to_front;
    int EXT_buffer_age;
    int EXT_client_extensions;
    int EXT_client_sync;
    int EXT_compositor;
    int EXT_config_select_group;
    int EXT_create_context_robustness;
    int EXT_device_base;
    int EXT_device_drm;
    int EXT_device_drm_render_node;
    int EXT_device_enumeration;
    int EXT_device_openwf;
    int EXT_device_persistent_id;
    int EXT_device_query;
    int EXT_device_query_name;
    int EXT_explicit_device;
    int EXT_gl_colorspace_bt2020_linear;
    int EXT_gl_colorspace_bt2020_pq;
    int EXT_gl_colorspace_display_p3;
    int EXT_gl_colorspace_display_p3_linear;
    int EXT_gl_colorspace_display_p3_passthrough;
    int EXT_gl_colorspace_scrgb;
    int EXT_gl_colorspace_scrgb_linear;
    int EXT_image_dma_buf_import;
    int EXT_image_dma_buf_import_modifiers;
    int EXT_image_gl_colorspace;
    int EXT_image_implicit_sync_control;
    int EXT_multiview_window;
    int EXT_output_base;
    int EXT_output_drm;
    int EXT_output_openwf;
    int EXT_pixel_format_float;
    int EXT_platform_base;
    int EXT_platform_device;
    int EXT_platform_wayland;
    int EXT_platform_x11;
    int EXT_platform_xcb;
    int EXT_present_opaque;
    int EXT_protected_content;
    int EXT_protected_surface;
    int EXT_stream_consumer_egloutput;
    int EXT_surface_CTA861_3_metadata;
    int EXT_surface_SMPTE2086_metadata;
    int EXT_surface_compression;
    int EXT_swap_buffers_with_damage;
    int EXT_sync_reuse;
    int EXT_yuv_surface;
    int HI_clientpixmap;
    int HI_colorformats;
    int IMG_context_priority;
    int IMG_image_plane_attribs;
    int KHR_cl_event;
    int KHR_cl_event2;
    int KHR_client_get_all_proc_addresses;
    int KHR_config_attribs;
    int KHR_context_flush_control;
    int KHR_create_context;
    int KHR_create_context_no_error;
    int KHR_debug;
    int KHR_display_reference;
    int KHR_fence_sync;
    int KHR_get_all_proc_addresses;
    int KHR_gl_colorspace;
    int KHR_gl_renderbuffer_image;
    int KHR_gl_texture_2D_image;
    int KHR_gl_texture_3D_image;
    int KHR_gl_texture_cubemap_image;
    int KHR_image;
    int KHR_image_base;
    int KHR_image_pixmap;
    int KHR_lock_surface;
    int KHR_lock_surface2;
    int KHR_lock_surface3;
    int KHR_mutable_render_buffer;
    int KHR_no_config_context;
    int KHR_partial_update;
    int KHR_platform_android;
    int KHR_platform_gbm;
    int KHR_platform_wayland;
    int KHR_platform_x11;
    int KHR_reusable_sync;
    int KHR_stream;
    int KHR_stream_attrib;
    int KHR_stream_consumer_gltexture;
    int KHR_stream_cross_process_fd;
    int KHR_stream_fifo;
    int KHR_stream_producer_aldatalocator;
    int KHR_stream_producer_eglsurface;
    int KHR_surfaceless_context;
    int KHR_swap_buffers_with_damage;
    int KHR_vg_parent_image;
    int KHR_wait_sync;
    int MESA_drm_image;
    int MESA_image_dma_buf_export;
    int MESA_platform_gbm;
    int MESA_platform_surfaceless;
    int MESA_query_driver;
    int NOK_swap_region;
    int NOK_swap_region2;
    int NOK_texture_from_pixmap;
    int NV_3dvision_surface;
    int NV_context_priority_realtime;
    int NV_coverage_sample;
    int NV_coverage_sample_resolve;
    int NV_cuda_event;
    int NV_depth_nonlinear;
    int NV_device_cuda;
    int NV_native_query;
    int NV_post_convert_rounding;
    int NV_post_sub_buffer;
    int NV_quadruple_buffer;
    int NV_robustness_video_memory_purge;
    int NV_stream_consumer_eglimage;
    int NV_stream_consumer_gltexture_yuv;
    int NV_stream_cross_display;
    int NV_stream_cross_object;
    int NV_stream_cross_partition;
    int NV_stream_cross_process;
    int NV_stream_cross_system;
    int NV_stream_dma;
    int NV_stream_fifo_next;
    int NV_stream_fifo_synchronous;
    int NV_stream_flush;
    int NV_stream_frame_limits;
    int NV_stream_metadata;
    int NV_stream_origin;
    int NV_stream_remote;
    int NV_stream_reset;
    int NV_stream_socket;
    int NV_stream_socket_inet;
    int NV_stream_socket_unix;
    int NV_stream_sync;
    int NV_sync;
    int NV_system_time;
    int NV_triple_buffer;
    int TIZEN_image_native_buffer;
    int TIZEN_image_native_surface;
    int WL_bind_wayland_display;
    int WL_create_wayland_buffer_from_image;
...
GladEGLContext* gladGetEGLContext(void);
